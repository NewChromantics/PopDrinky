...
uniform vec3 WorldQuadMin;
uniform vec3 WorldQuadMax;
uniform float RealTimeNormal;

uniform float BlitProjection;	//	else in world space
...
void main()
{
	...
	vec4 WorldPos;
	WorldPos.xyz = mix( WorldQuadMin, WorldQuadMax, LocalPos01 );
	WorldPos.w = 1.0;
	...
	if ( BlitProjection > 0.5 )
		gl_Position = vec4(LocalPosition.xzy,1);
